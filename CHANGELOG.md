...
- Added the resumable `forge.mjs` state machine and JSON contracts.
- Added rebuild and author orchestration instructions for Codex Desktop.
- Added honest native-vector and embedded-raster SVG assets.
