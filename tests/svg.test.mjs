...
import { writeAssetSvgs, writeCompositeSvg } from "../plugins/paper-diagram-forge/skills/build-paper-framework-diagrams/scripts/lib/svg.mjs";
import { fixturePath, json, temporaryDirectory } from "./helpers.mjs";
import { loadSharp } from "../plugins/paper-diagram-forge/skills/build-paper-framework-diagrams/scripts/lib/runtime.mjs";
